...
def feed_actions(baby_name):
    ...
    new_feed_log = {"feed time" : feed_time, "feed duration" : feed_duration}
...
def sleep_actions(baby_name):
    ...
    new_sleep_log = {"sleep time" : sleep_time, "sleep duration" : sleep_duration} 
...
def cry_actions(baby_name):
    ...
    new_cry_log = {"cry time" : cry_time, "cry duration" : cry_duration}
